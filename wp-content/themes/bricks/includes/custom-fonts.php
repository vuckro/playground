	...
	public function register_post_type() {
		...
		if ( ! Builder_Permissions::user_has_permission( 'access_font_manager' ) ) {
			...
			if ( empty( $font_manager_capabilities ) ) {
				...
				// Map each operation to all capabilities that have fonts manager access
				$args['capability_type'] = 'post';
				$args['capabilities']    = [
					'read_post'    => $font_manager_capabilities,
					'edit_post'    => $font_manager_capabilities,
					'delete_post'  => $font_manager_capabilities,
					'create_posts' => $font_manager_capabilities,
				];
			}
		}
