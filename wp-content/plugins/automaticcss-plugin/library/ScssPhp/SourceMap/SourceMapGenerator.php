...
namespace Automatic_CSS\ScssPhp\SourceMap;
...
class SourceMapGenerator
{
     ...
     *
     * @var \Automatic_CSS\ScssPhp\SourceMap\Base64VLQ
     */
    protected $encoder;
     ...
     * @return string|null
     *
     * @throws \Automatic_CSS\ScssPhp\Exception\CompilerException If the file could not be saved
     * @deprecated
     */
