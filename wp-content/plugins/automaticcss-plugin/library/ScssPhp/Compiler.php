...
use Automatic_CSS\ScssPhp\Base\Range;
use Automatic_CSS\ScssPhp\Block\AtRootBlock;
use Automatic_CSS\ScssPhp\Block\CallableBlock;
use Automatic_CSS\ScssPhp\Block\DirectiveBlock;
use Automatic_CSS\ScssPhp\Block\EachBlock;
use Automatic_CSS\ScssPhp\Block\ElseBlock;
use Automatic_CSS\ScssPhp\Block\ElseifBlock;
use Automatic_CSS\ScssPhp\Block\ForBlock;
use Automatic_CSS\ScssPhp\Block\IfBlock;
use Automatic_CSS\ScssPhp\Block\MediaBlock;
use Automatic_CSS\ScssPhp\Block\NestedPropertyBlock;
use Automatic_CSS\ScssPhp\Block\WhileBlock;
use Automatic_CSS\ScssPhp\Compiler\CachedResult;
use Automatic_CSS\ScssPhp\Compiler\Environment;
use Automatic_CSS\ScssPhp\Exception\CompilerException;
use Automatic_CSS\ScssPhp\Exception\ParserException;
use Automatic_CSS\ScssPhp\Exception\SassException;
use Automatic_CSS\ScssPhp\Exception\SassScriptException;
use Automatic_CSS\ScssPhp\Formatter\Compressed;
use Automatic_CSS\ScssPhp\Formatter\Expanded;
use Automatic_CSS\ScssPhp\Formatter\OutputBlock;
use Automatic_CSS\ScssPhp\Logger\LoggerInterface;
use Automatic_CSS\ScssPhp\Logger\StreamLogger;
use Automatic_CSS\ScssPhp\Node\Number;
use Automatic_CSS\ScssPhp\SourceMap\SourceMapGenerator;
use Automatic_CSS\ScssPhp\Util\Path;
...
class Compiler
{
    ...
    /**
     * @var \Automatic_CSS\ScssPhp\Compiler\Environment
     */
    protected $env;
    /**
     * @var OutputBlock|null
     ...
     * @param string|null $path
     *
     * @return \Automatic_CSS\ScssPhp\Parser
     */
     ...
     *
     * @return \Automatic_CSS\ScssPhp\Formatter\OutputBlock
     */
     ...
     * Compile root
     *
     * @param \Automatic_CSS\ScssPhp\Block $rootBlock
     *
     * @return void
     */
     ...
     * Flatten selectors
     *
     * @param \Automatic_CSS\ScssPhp\Formatter\OutputBlock $block
     ...
     * Compile media
     *
     * @param \Automatic_CSS\ScssPhp\Block $media
     *
     * @return void
     */
     ...
     * Media parent
     *
     * @param \Automatic_CSS\ScssPhp\Formatter\OutputBlock $scope
     *
     * @return \Automatic_CSS\ScssPhp\Formatter\OutputBlock
     */
     ...
     * @param \Automatic_CSS\ScssPhp\Formatter\OutputBlock $out
     *
     * @return void
     */
     ...
     * Compile at-root
     *
     * @param \Automatic_CSS\ScssPhp\Block $block
     *
     * @return void
     */
     ...
     *
     * @param \Automatic_CSS\ScssPhp\Formatter\OutputBlock $scope
     * @param \Automatic_CSS\ScssPhp\Formatter\OutputBlock $previousScope
     *
     * @return OutputBlock
     */
     ...
     * Filter WITH rules
     *
     * @param \Automatic_CSS\ScssPhp\Block|\Automatic_CSS\ScssPhp\Formatter\OutputBlock $block
     * @param array                                                         $with
     * @param array                                                         $without
     *
     * @return bool
     ...
     * @param array[]                                $stms
     * @param \Automatic_CSS\ScssPhp\Formatter\OutputBlock $out
     * @param \Automatic_CSS\ScssPhp\Block                 $selfParent
     * @param string                                 $traceName
     *
     * @return void
     *
...
EOL;
    ...
    protected function fncall($functionReference, $argValues)
    {
        ...
        switch ($functionReference[1]) {
            ...
            case 'native':
                ...
                // special cases of css valid functions Mobile/Desktop
     ...
     *
     * @param \Automatic_CSS\ScssPhp\Compiler\Environment $env
     * @param \Automatic_CSS\ScssPhp\Block                $selfParent
     *
     * @return array
     */
     ...
     * @param \Automatic_CSS\ScssPhp\Block $block
     *
     * @return \Automatic_CSS\ScssPhp\Compiler\Environment
     */
    ...
    public function addVariables(array $variables)
    {
        ...
        if ($triggerWarning) {
            @trigger_error('Passing raw values to as custom variables to the Compiler is deprecated. Use "\Automatic_CSS\ScssPhp\ValueConverter::parseValue" or "\Automatic_CSS\ScssPhp\ValueConverter::fromPhp" to convert them instead.', E_USER_DEPRECATED);
        }
    }
     ...
     *
     * @return \Automatic_CSS\ScssPhp\Compiler
     *
     ...
     * @return never
     *
     * @throws \Automatic_CSS\ScssPhp\Exception\CompilerException
     *
